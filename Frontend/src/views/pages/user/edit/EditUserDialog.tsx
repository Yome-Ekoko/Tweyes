...
import { EditUserRequest } from 'src/types/requestTypes'
import { apiEditUser } from 'src/services/UserService'
...
const EditUserDialog = (props: EditUserDialogProps) => {
  const { open, toggle, existingUser, mutate } = props
  ...
  useEffect(() => {
    ...
    setValue('role', existingUser?.roles?.find(x=>x!==undefined) ?? '')
